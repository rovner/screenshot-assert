...
import static io.rovner.screenshot.assertions.core.screenshot.Screenshots.screenshotOfElement;
...
public class ElementScreenshotTest {
    ...
    void shouldReturnScreenshot() {
        ...
        BufferedImage screenshot = screenshotOfElement(webElement).take(webDriver);
    ...
    void shouldDescribe1() {
        ...
        assertThat(screenshotOfElement(webElement).describe())
    ...
    void shouldDescribe2() {
        when(webElement.toString()).thenReturn("web-element-to-string");
        assertThat(screenshotOfElement(webElement).as("some element").describe())
