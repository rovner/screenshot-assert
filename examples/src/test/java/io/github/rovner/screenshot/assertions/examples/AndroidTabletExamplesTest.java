...
public class AndroidTabletExamplesTest {
    private WebDriver wd;

    @RegisterExtension
    private final ScreenshotAssertExtension screenshotAssert = new ScreenshotAssertExtension(() -> wd)
            .addPlatformScreenshooter("android-tablet",
                    new CuttingBrowserScreenshooter(ofMillis(1000), asList(fixedFooter(60), floatingHeader())) {
                        @Override
    ...
    void beforeEach() throws IOException {
        ...
        capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "Pixel C");
